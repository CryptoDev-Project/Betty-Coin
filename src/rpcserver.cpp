...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BETTY features */
        {"betty", "masternode", &masternode, true, true, false},
        {"betty", "listmasternodes", &listmasternodes, true, true, false},
        {"betty", "getmasternodecount", &getmasternodecount, true, true, false},
        {"betty", "masternodeconnect", &masternodeconnect, true, true, false},
        {"betty", "masternodecurrent", &masternodecurrent, true, true, false},
        {"betty", "masternodedebug", &masternodedebug, true, true, false},
        {"betty", "startmasternode", &startmasternode, true, true, false},
        {"betty", "createmasternodekey", &createmasternodekey, true, true, false},
        {"betty", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"betty", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"betty", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"betty", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"betty", "getmasternodescores", &getmasternodescores, true, true, false},
        {"betty", "mnbudget", &mnbudget, true, true, false},
        {"betty", "preparebudget", &preparebudget, true, true, false},
        {"betty", "submitbudget", &submitbudget, true, true, false},
        {"betty", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"betty", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"betty", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"betty", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"betty", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"betty", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"betty", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"betty", "checkbudgets", &checkbudgets, true, true, false},
        {"betty", "mnsync", &mnsync, true, true, false},
        {"betty", "spork", &spork, true, true, false},
        {"betty", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"betty", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bettyd, or the -server option to betty-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> betty-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7775/\n";
}
