...
/** Utility functions used by the BETTY Qt UI.
 */
namespace GUIUtil
{
...
// Render BETTY addresses in monospace font
...
// Parse "betty:" URI into recipient object, return true on successful parsing
