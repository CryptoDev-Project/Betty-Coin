                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BETTY from zBETTY"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBETTY"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBETTY));
