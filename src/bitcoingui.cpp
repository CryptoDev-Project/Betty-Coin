...
// Copyright (c) 2015-2018 The BETTY developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BETTY Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BETTY address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BETTY: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBETTY"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BETTY Core"), this);
    aboutAction->setStatusTip(tr("Show information about BETTY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BETTY"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BETTY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BETTY addresses"));
    ...
    openAction->setStatusTip(tr("Open a BETTY: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BETTY Core help message to get a list with possible BETTY command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BETTY Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BETTY network", "", count));
}
...
{
    QString strTitle = tr("BETTY Core"); // default title
