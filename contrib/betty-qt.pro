...
RESOURCES += src/qt/betty.qrc src/qt/betty_locale.qrc

TRANSLATIONS += src/qt/locale/betty_bg.ts \
                src/qt/locale/betty_de.ts \
                src/qt/locale/betty_en.ts \
                src/qt/locale/betty_es.ts \
                src/qt/locale/betty_fi.ts \
                src/qt/locale/betty_fr.ts \
                src/qt/locale/betty_it.ts \
                src/qt/locale/betty_ja.ts \
                src/qt/locale/betty_pl.ts \
                src/qt/locale/betty_pt.ts \
                src/qt/locale/betty_ru.ts \
                src/qt/locale/betty_sk.ts \
                src/qt/locale/betty_sv.ts \
                src/qt/locale/betty_vi.ts \
                src/qt/locale/betty_zh_CN.ts \
                src/qt/locale/betty_zh_TW.ts
