...
In order to support loading of multiple wallets in betty-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is betty.cpp.
...
Changes to betty.cpp
----------------------
betty.cpp is the entry point into betty-qt, and as such, will require some minor modifications to provide hooks for
