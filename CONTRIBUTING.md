Contributing to BETTY Core
============================

The BETTY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BETTY Core project, and is not to be
confused with overall BETTY Network Protocol consensus changes.

Whether a pull request is merged into BETTY Core rests with the project merge
...
Patches that change BETTY consensus rules are considerably more involved than
...
Where a patch set proposes to change the BETTY consensus, it must have been
...
The project leader is the release manager for each BETTY Core release.
